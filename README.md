...
This project was inspired by and developed with guidance from the [Blue-Merle](https://github.com/srlabs/blue-merle?tab=readme-ov-file#mac-address-log-wiping) project.
